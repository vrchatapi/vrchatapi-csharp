...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IInviteApi : IApiAccessor
    {
        ...
        ApiResponse<Notification> InviteUserWithHttpInfo (string userId);
        /// <summary>
        /// Request Invite
        /// </summary>
        /// <remarks>
        ...
        /// <param name="notificationId"></param>
        /// <returns>ApiResponse of Notification</returns>
        ApiResponse<Notification> RespondInviteWithHttpInfo (string notificationId);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Notification> InviteUserAsync (string userId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Notification>> InviteUserWithHttpInfoAsync (string userId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Request Invite
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Notification</returns>
        System.Threading.Tasks.Task<Notification> RespondInviteAsync (string notificationId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        System.Threading.Tasks.Task<ApiResponse<Notification>> RespondInviteWithHttpInfoAsync (string notificationId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update Invite Message
        /// </summary>
        /// <remarks>
    ...
    public partial class InviteApi : IInviteApi
    {
        ...
        /// <param name="userId"></param>
        /// <returns>Notification</returns>
        public Notification InviteUser (string userId)
        {
             ApiResponse<Notification> localVarResponse = InviteUserWithHttpInfo(userId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="userId"></param>
        /// <returns>ApiResponse of Notification</returns>
        public ApiResponse<Notification> InviteUserWithHttpInfo (string userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Notification</returns>
        public async System.Threading.Tasks.Task<Notification> InviteUserAsync (string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Notification> localVarResponse = await InviteUserWithHttpInfoAsync(userId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Notification>> InviteUserWithHttpInfoAsync (string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling InviteApi->InviteUser");
        ...
        /// <param name="notificationId"></param>
        /// <returns>Notification</returns>
        public Notification RespondInvite (string notificationId)
        {
             ApiResponse<Notification> localVarResponse = RespondInviteWithHttpInfo(notificationId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="notificationId"></param>
        /// <returns>ApiResponse of Notification</returns>
        public ApiResponse<Notification> RespondInviteWithHttpInfo (string notificationId)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Notification</returns>
        public async System.Threading.Tasks.Task<Notification> RespondInviteAsync (string notificationId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Notification> localVarResponse = await RespondInviteWithHttpInfoAsync(notificationId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Notification>> RespondInviteWithHttpInfoAsync (string notificationId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'notificationId' is set
            if (notificationId == null)
                throw new ApiException(400, "Missing required parameter 'notificationId' when calling InviteApi->RespondInvite");
