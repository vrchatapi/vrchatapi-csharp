...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IInviteApi : IApiAccessor
    {
        ...
        ApiResponse<InviteMessage> GetInviteMessageWithHttpInfo (string userId, string messageType, int messageId);
        /// <summary>
        ...
        /// <param name="messageId"></param>
        /// <returns>ApiResponse of List&lt;InviteMessage&gt;</returns>
        ApiResponse<List<InviteMessage>> ResetInviteMessageWithHttpInfo (string userId, string messageType, int messageId);
        /// <summary>
        /// Respond Invite
        /// </summary>
        /// <remarks>
        ...
        /// <param name="messageId"></param>
        /// <returns>ApiResponse of List&lt;InviteMessage&gt;</returns>
        ApiResponse<List<InviteMessage>> UpdateInviteMessageWithHttpInfo (string userId, string messageType, int messageId);
        ...
        System.Threading.Tasks.Task<InviteMessage> GetInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InviteMessage>> GetInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List Invite Messages
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;InviteMessage&gt;</returns>
        System.Threading.Tasks.Task<List<InviteMessage>> ResetInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;InviteMessage&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<InviteMessage>>> ResetInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Respond Invite
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;InviteMessage&gt;</returns>
        System.Threading.Tasks.Task<List<InviteMessage>> UpdateInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;InviteMessage&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<InviteMessage>>> UpdateInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class InviteApi : IInviteApi
    {
        ...
        /// <summary>
        /// Get Invite Messages Returns a single Invite Message. This returns the exact same information but less than &#x60;getInviteMessages&#x60;. Admin Credentials are required to view messages of other users!  Message type refers to a different collection of messages, used during different types of responses.  * &#x60;message&#x60; &#x3D; Message during a normal invite * &#x60;response&#x60; &#x3D; Message when replying to a message * &#x60;request&#x60; &#x3D; Message when requesting an invite * &#x60;requestResponse&#x60; &#x3D; Message when replying to a request for invite
        /// </summary>
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId"></param>
        /// <param name="messageType"></param>
        /// <param name="messageId"></param>
        /// <returns>InviteMessage</returns>
        public InviteMessage GetInviteMessage (string userId, string messageType, int messageId)
        {
             ApiResponse<InviteMessage> localVarResponse = GetInviteMessageWithHttpInfo(userId, messageType, messageId);
        ...
        /// <param name="messageId"></param>
        /// <returns>ApiResponse of InviteMessage</returns>
        public ApiResponse<InviteMessage> GetInviteMessageWithHttpInfo (string userId, string messageType, int messageId)
        {
            ...
            var localVarPath = "/message/{userId}/{messageType}/{messageId}";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of InviteMessage</returns>
        public async System.Threading.Tasks.Task<InviteMessage> GetInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<InviteMessage> localVarResponse = await GetInviteMessageWithHttpInfoAsync(userId, messageType, messageId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (InviteMessage)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InviteMessage>> GetInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling InviteApi->GetInviteMessage");
        ...
        /// <param name="messageId"></param>
        /// <returns>List&lt;InviteMessage&gt;</returns>
        public List<InviteMessage> ResetInviteMessage (string userId, string messageType, int messageId)
        {
             ApiResponse<List<InviteMessage>> localVarResponse = ResetInviteMessageWithHttpInfo(userId, messageType, messageId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="messageId"></param>
        /// <returns>ApiResponse of List&lt;InviteMessage&gt;</returns>
        public ApiResponse<List<InviteMessage>> ResetInviteMessageWithHttpInfo (string userId, string messageType, int messageId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;InviteMessage&gt;</returns>
        public async System.Threading.Tasks.Task<List<InviteMessage>> ResetInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<InviteMessage>> localVarResponse = await ResetInviteMessageWithHttpInfoAsync(userId, messageType, messageId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;InviteMessage&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<InviteMessage>>> ResetInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling InviteApi->ResetInviteMessage");
        ...
        /// <param name="messageId"></param>
        /// <returns>List&lt;InviteMessage&gt;</returns>
        public List<InviteMessage> UpdateInviteMessage (string userId, string messageType, int messageId)
        {
             ApiResponse<List<InviteMessage>> localVarResponse = UpdateInviteMessageWithHttpInfo(userId, messageType, messageId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="messageId"></param>
        /// <returns>ApiResponse of List&lt;InviteMessage&gt;</returns>
        public ApiResponse<List<InviteMessage>> UpdateInviteMessageWithHttpInfo (string userId, string messageType, int messageId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;InviteMessage&gt;</returns>
        public async System.Threading.Tasks.Task<List<InviteMessage>> UpdateInviteMessageAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<InviteMessage>> localVarResponse = await UpdateInviteMessageWithHttpInfoAsync(userId, messageType, messageId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;InviteMessage&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<InviteMessage>>> UpdateInviteMessageWithHttpInfoAsync (string userId, string messageType, int messageId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling InviteApi->UpdateInviteMessage");
