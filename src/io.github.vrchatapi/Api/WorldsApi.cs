...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IWorldsApi : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2006> GetWorldPublishStatusWithHttpInfo (string worldId);
        /// <summary>
        /// Publish World
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2006> GetWorldPublishStatusAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> GetWorldPublishStatusWithHttpInfoAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Publish World
        /// </summary>
        /// <remarks>
    ...
    public partial class WorldsApi : IWorldsApi
    {
        ...
        /// <param name="worldId"></param>
        /// <returns>InlineResponse2006</returns>
        public InlineResponse2006 GetWorldPublishStatus (string worldId)
        {
             ApiResponse<InlineResponse2006> localVarResponse = GetWorldPublishStatusWithHttpInfo(worldId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="worldId"></param>
        /// <returns>ApiResponse of InlineResponse2006</returns>
        public ApiResponse<InlineResponse2006> GetWorldPublishStatusWithHttpInfo (string worldId)
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of InlineResponse2006</returns>
        public async System.Threading.Tasks.Task<InlineResponse2006> GetWorldPublishStatusAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<InlineResponse2006> localVarResponse = await GetWorldPublishStatusWithHttpInfoAsync(worldId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (InlineResponse2006)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> GetWorldPublishStatusWithHttpInfoAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
                throw new ApiException(400, "Missing required parameter 'worldId' when calling WorldsApi->GetWorldPublishStatus");
