...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IWorldsApi : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse2007> GetWorldPublishWithHttpInfo (string worldId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse2007> GetWorldPublishAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2007>> GetWorldPublishWithHttpInfoAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class WorldsApi : IWorldsApi
    {
        ...
        /// <summary>
        /// Get World Metadata Returns a worlds custom metadata. This is currently believed to be unused. Metadata can be set with &#x60;updateWorld&#x60; and can be any arbitrary object.
        /// </summary>
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="worldId"></param>
        /// <returns>InlineResponse2006</returns>
        ...
        /// <summary>
        /// Get World Publish Status Returns a worlds publish status. This is currently believed to be unused.
        /// </summary>
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="worldId"></param>
        /// <returns>InlineResponse2007</returns>
        public InlineResponse2007 GetWorldPublish (string worldId)
        {
             ApiResponse<InlineResponse2007> localVarResponse = GetWorldPublishWithHttpInfo(worldId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="worldId"></param>
        /// <returns>ApiResponse of InlineResponse2007</returns>
        public ApiResponse<InlineResponse2007> GetWorldPublishWithHttpInfo (string worldId)
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
                throw new ApiException(400, "Missing required parameter 'worldId' when calling WorldsApi->GetWorldPublish");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetWorldPublish", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of InlineResponse2007</returns>
        public async System.Threading.Tasks.Task<InlineResponse2007> GetWorldPublishAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<InlineResponse2007> localVarResponse = await GetWorldPublishWithHttpInfoAsync(worldId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (InlineResponse2007)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2007>> GetWorldPublishWithHttpInfoAsync (string worldId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
                throw new ApiException(400, "Missing required parameter 'worldId' when calling WorldsApi->GetWorldPublish");
