...
namespace io.github.vrchatapi.Api
{
    ...
    public partial class EconomyApi : IEconomyApi
    {
        ...
        /// <returns></returns>
        public EconomyApi(io.github.vrchatapi.Client.Configuration configuration)
        {
        ...
        public EconomyApi(io.github.vrchatapi.Client.ISynchronousClient client, io.github.vrchatapi.Client.IAsynchronousClient asyncClient, io.github.vrchatapi.Client.IReadableConfiguration configuration)
        {
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<UserSubscription>> localVarResponse = GetCurrentSubscriptionsWithHttpInfo();
        ...
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;UserSubscription&gt;</returns>
        public io.github.vrchatapi.Client.ApiResponse<List<UserSubscription>> GetCurrentSubscriptionsWithHttpInfo()
        {
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<UserSubscription>> localVarResponse = await GetCurrentSubscriptionsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;UserSubscription&gt;)</returns>
        public async System.Threading.Tasks.Task<io.github.vrchatapi.Client.ApiResponse<List<UserSubscription>>> GetCurrentSubscriptionsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<LicenseGroup> localVarResponse = GetLicenseGroupWithHttpInfo(licenseGroupId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="licenseGroupId"></param>
        /// <returns>ApiResponse of LicenseGroup</returns>
        public io.github.vrchatapi.Client.ApiResponse<LicenseGroup> GetLicenseGroupWithHttpInfo(string licenseGroupId)
        {
            // verify the required parameter 'licenseGroupId' is set
            if (licenseGroupId == null)
                throw new io.github.vrchatapi.Client.ApiException(400, "Missing required parameter 'licenseGroupId' when calling EconomyApi->GetLicenseGroup");
            ...
            localVarRequestOptions.PathParameters.Add("licenseGroupId", io.github.vrchatapi.Client.ClientUtils.ParameterToString(licenseGroupId)); // path parameter
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<LicenseGroup> localVarResponse = await GetLicenseGroupWithHttpInfoAsync(licenseGroupId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LicenseGroup)</returns>
        public async System.Threading.Tasks.Task<io.github.vrchatapi.Client.ApiResponse<LicenseGroup>> GetLicenseGroupWithHttpInfoAsync(string licenseGroupId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'licenseGroupId' is set
            if (licenseGroupId == null)
                throw new io.github.vrchatapi.Client.ApiException(400, "Missing required parameter 'licenseGroupId' when calling EconomyApi->GetLicenseGroup");
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<Transaction> localVarResponse = GetSteamTransactionWithHttpInfo(transactionId);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of Transaction</returns>
        [Obsolete]
        public io.github.vrchatapi.Client.ApiResponse<Transaction> GetSteamTransactionWithHttpInfo(string transactionId)
        {
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new io.github.vrchatapi.Client.ApiException(400, "Missing required parameter 'transactionId' when calling EconomyApi->GetSteamTransaction");
            ...
            localVarRequestOptions.PathParameters.Add("transactionId", io.github.vrchatapi.Client.ClientUtils.ParameterToString(transactionId)); // path parameter
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<Transaction> localVarResponse = await GetSteamTransactionWithHttpInfoAsync(transactionId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (Transaction)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<io.github.vrchatapi.Client.ApiResponse<Transaction>> GetSteamTransactionWithHttpInfoAsync(string transactionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'transactionId' is set
            if (transactionId == null)
                throw new io.github.vrchatapi.Client.ApiException(400, "Missing required parameter 'transactionId' when calling EconomyApi->GetSteamTransaction");
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<Transaction>> localVarResponse = GetSteamTransactionsWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Transaction&gt;</returns>
        public io.github.vrchatapi.Client.ApiResponse<List<Transaction>> GetSteamTransactionsWithHttpInfo()
        {
            io.github.vrchatapi.Client.RequestOptions localVarRequestOptions = new io.github.vrchatapi.Client.RequestOptions();
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<Transaction>> localVarResponse = await GetSteamTransactionsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Transaction&gt;)</returns>
        public async System.Threading.Tasks.Task<io.github.vrchatapi.Client.ApiResponse<List<Transaction>>> GetSteamTransactionsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<Subscription>> localVarResponse = GetSubscriptionsWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="io.github.vrchatapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Subscription&gt;</returns>
        public io.github.vrchatapi.Client.ApiResponse<List<Subscription>> GetSubscriptionsWithHttpInfo()
        {
            io.github.vrchatapi.Client.RequestOptions localVarRequestOptions = new io.github.vrchatapi.Client.RequestOptions();
        ...
        {
            io.github.vrchatapi.Client.ApiResponse<List<Subscription>> localVarResponse = await GetSubscriptionsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Subscription&gt;)</returns>
        public async System.Threading.Tasks.Task<io.github.vrchatapi.Client.ApiResponse<List<Subscription>>> GetSubscriptionsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
