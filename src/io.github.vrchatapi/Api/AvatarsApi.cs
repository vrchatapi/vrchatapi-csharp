...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IAvatarsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Avatar> CreateAvatarAsync (CreateAvatarRequest createAvatarRequest = default(CreateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Avatar>> CreateAvatarWithHttpInfoAsync (CreateAvatarRequest createAvatarRequest = default(CreateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete Avatar
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CurrentUser</returns>
        System.Threading.Tasks.Task<CurrentUser> SelectFallbackAvatarAsync (string avatarId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CurrentUser)</returns>
        System.Threading.Tasks.Task<ApiResponse<CurrentUser>> SelectFallbackAvatarWithHttpInfoAsync (string avatarId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update Avatar
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Avatar</returns>
        System.Threading.Tasks.Task<Avatar> UpdateAvatarAsync (string avatarId, UpdateAvatarRequest updateAvatarRequest = default(UpdateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Avatar)</returns>
        System.Threading.Tasks.Task<ApiResponse<Avatar>> UpdateAvatarWithHttpInfoAsync (string avatarId, UpdateAvatarRequest updateAvatarRequest = default(UpdateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AvatarsApi : IAvatarsApi
    {
        ...
        {
             ApiResponse<Avatar> localVarResponse = CreateAvatarWithHttpInfo(createAvatarRequest);
        ...
        /// <param name="createAvatarRequest"> (optional)</param>
        /// <returns>ApiResponse of Avatar</returns>
        public ApiResponse<Avatar> CreateAvatarWithHttpInfo (CreateAvatarRequest createAvatarRequest = default(CreateAvatarRequest))
        {
            ...
            if (createAvatarRequest != null && createAvatarRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(createAvatarRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = createAvatarRequest; // byte array
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Avatar</returns>
        public async System.Threading.Tasks.Task<Avatar> CreateAvatarAsync (CreateAvatarRequest createAvatarRequest = default(CreateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Avatar> localVarResponse = await CreateAvatarWithHttpInfoAsync(createAvatarRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Avatar)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Avatar>> CreateAvatarWithHttpInfoAsync (CreateAvatarRequest createAvatarRequest = default(CreateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        {
             ApiResponse<CurrentUser> localVarResponse = SelectFallbackAvatarWithHttpInfo(avatarId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="avatarId"></param>
        /// <returns>ApiResponse of CurrentUser</returns>
        public ApiResponse<CurrentUser> SelectFallbackAvatarWithHttpInfo (string avatarId)
        {
            // verify the required parameter 'avatarId' is set
            if (avatarId == null)
                throw new ApiException(400, "Missing required parameter 'avatarId' when calling AvatarsApi->SelectFallbackAvatar");

            var localVarPath = "/avatars/{avatarId}/selectFallback";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("SelectFallbackAvatar", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CurrentUser</returns>
        public async System.Threading.Tasks.Task<CurrentUser> SelectFallbackAvatarAsync (string avatarId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CurrentUser> localVarResponse = await SelectFallbackAvatarWithHttpInfoAsync(avatarId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CurrentUser)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CurrentUser>> SelectFallbackAvatarWithHttpInfoAsync (string avatarId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'avatarId' is set
            if (avatarId == null)
                throw new ApiException(400, "Missing required parameter 'avatarId' when calling AvatarsApi->SelectFallbackAvatar");
        ...
        {
             ApiResponse<Avatar> localVarResponse = UpdateAvatarWithHttpInfo(avatarId, updateAvatarRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="updateAvatarRequest"> (optional)</param>
        /// <returns>ApiResponse of Avatar</returns>
        public ApiResponse<Avatar> UpdateAvatarWithHttpInfo (string avatarId, UpdateAvatarRequest updateAvatarRequest = default(UpdateAvatarRequest))
        {
            // verify the required parameter 'avatarId' is set
            if (avatarId == null)
            ...
            if (avatarId != null) localVarPathParams.Add("avatarId", this.Configuration.ApiClient.ParameterToString(avatarId)); // path parameter
            if (updateAvatarRequest != null && updateAvatarRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(updateAvatarRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = updateAvatarRequest; // byte array
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Avatar</returns>
        public async System.Threading.Tasks.Task<Avatar> UpdateAvatarAsync (string avatarId, UpdateAvatarRequest updateAvatarRequest = default(UpdateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Avatar> localVarResponse = await UpdateAvatarWithHttpInfoAsync(avatarId, updateAvatarRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Avatar)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Avatar>> UpdateAvatarWithHttpInfoAsync (string avatarId, UpdateAvatarRequest updateAvatarRequest = default(UpdateAvatarRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'avatarId' is set
            if (avatarId == null)
                throw new ApiException(400, "Missing required parameter 'avatarId' when calling AvatarsApi->UpdateAvatar");
