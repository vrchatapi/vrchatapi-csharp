...
namespace io.github.vrchatapi.Api
{
    ...
    public interface ISystemApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<InfoPush>> GetInfoPushAsync (string require = default(string), string include = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<InfoPush>>> GetInfoPushWithHttpInfoAsync (string require = default(string), string include = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Download JavaScript
        /// </summary>
        /// <remarks>
    ...
    public partial class SystemApi : ISystemApi
    {
        ...
        {
             ApiResponse<List<InfoPush>> localVarResponse = GetInfoPushWithHttpInfo(require, include);
             return localVarResponse.Data;
        }
        ...
        /// <param name="include">Tags to include (comma-separated). Any of the tags needs to be present. (optional)</param>
        /// <returns>ApiResponse of List&lt;InfoPush&gt;</returns>
        public ApiResponse<List<InfoPush>> GetInfoPushWithHttpInfo (string require = default(string), string include = default(string))
        {

            var localVarPath = "/infoPush";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (require != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "require", require)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetInfoPush", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<List<InfoPush>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (List<InfoPush>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<InfoPush>)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;InfoPush&gt;</returns>
        public async System.Threading.Tasks.Task<List<InfoPush>> GetInfoPushAsync (string require = default(string), string include = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<InfoPush>> localVarResponse = await GetInfoPushWithHttpInfoAsync(require, include, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;InfoPush&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<InfoPush>>> GetInfoPushWithHttpInfoAsync (string require = default(string), string include = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
