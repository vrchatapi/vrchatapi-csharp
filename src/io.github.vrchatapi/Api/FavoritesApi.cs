...
namespace io.github.vrchatapi.Api
{
    ...
    public interface IFavoritesApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Favorite> AddFavoriteAsync (AddFavoriteRequest addFavoriteRequest = default(AddFavoriteRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Favorite>> AddFavoriteWithHttpInfoAsync (AddFavoriteRequest addFavoriteRequest = default(AddFavoriteRequest), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Clear Favorite Group
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task UpdateFavoriteGroupAsync (string favoriteGroupType, string favoriteGroupName, string userId, UpdateFavoriteGroupRequest updateFavoriteGroupRequest = default(UpdateFavoriteGroupRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateFavoriteGroupWithHttpInfoAsync (string favoriteGroupType, string favoriteGroupName, string userId, UpdateFavoriteGroupRequest updateFavoriteGroupRequest = default(UpdateFavoriteGroupRequest), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class FavoritesApi : IFavoritesApi
    {
        ...
        {
             ApiResponse<Favorite> localVarResponse = AddFavoriteWithHttpInfo(addFavoriteRequest);
        ...
        /// <param name="addFavoriteRequest"> (optional)</param>
        /// <returns>ApiResponse of Favorite</returns>
        public ApiResponse<Favorite> AddFavoriteWithHttpInfo (AddFavoriteRequest addFavoriteRequest = default(AddFavoriteRequest))
        {
            ...
            if (addFavoriteRequest != null && addFavoriteRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(addFavoriteRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = addFavoriteRequest; // byte array
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Favorite</returns>
        public async System.Threading.Tasks.Task<Favorite> AddFavoriteAsync (AddFavoriteRequest addFavoriteRequest = default(AddFavoriteRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Favorite> localVarResponse = await AddFavoriteWithHttpInfoAsync(addFavoriteRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Favorite)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Favorite>> AddFavoriteWithHttpInfoAsync (AddFavoriteRequest addFavoriteRequest = default(AddFavoriteRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="updateFavoriteGroupRequest"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> UpdateFavoriteGroupWithHttpInfo (string favoriteGroupType, string favoriteGroupName, string userId, UpdateFavoriteGroupRequest updateFavoriteGroupRequest = default(UpdateFavoriteGroupRequest))
        {
            // verify the required parameter 'favoriteGroupType' is set
            if (favoriteGroupType == null)
            ...
            if (favoriteGroupName != null) localVarPathParams.Add("favoriteGroupName", this.Configuration.ApiClient.ParameterToString(favoriteGroupName)); // path parameter
            if (userId != null) localVarPathParams.Add("userId", this.Configuration.ApiClient.ParameterToString(userId)); // path parameter
            if (updateFavoriteGroupRequest != null && updateFavoriteGroupRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(updateFavoriteGroupRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = updateFavoriteGroupRequest; // byte array
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateFavoriteGroupAsync (string favoriteGroupType, string favoriteGroupName, string userId, UpdateFavoriteGroupRequest updateFavoriteGroupRequest = default(UpdateFavoriteGroupRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             await UpdateFavoriteGroupWithHttpInfoAsync(favoriteGroupType, favoriteGroupName, userId, updateFavoriteGroupRequest, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UpdateFavoriteGroupWithHttpInfoAsync (string favoriteGroupType, string favoriteGroupName, string userId, UpdateFavoriteGroupRequest updateFavoriteGroupRequest = default(UpdateFavoriteGroupRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'favoriteGroupType' is set
            if (favoriteGroupType == null)
                throw new ApiException(400, "Missing required parameter 'favoriteGroupType' when calling FavoritesApi->UpdateFavoriteGroup");
