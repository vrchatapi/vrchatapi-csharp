...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class DownloadURLList :  IEquatable<DownloadURLList>, IValidatableObject
    {
        ...
        public DownloadURLList(string sdk2 = default(string), string sdk3Avatars = default(string), string sdk3Worlds = default(string))
        {
            ...
            if (sdk2 == null)
            {
                throw new InvalidDataException("sdk2 is a required property for DownloadURLList and cannot be null");
            }
            else
            {
                this.Sdk2 = sdk2;
            ...
            if (sdk3Avatars == null)
            {
                throw new InvalidDataException("sdk3Avatars is a required property for DownloadURLList and cannot be null");
            }
            else
            {
            ...
            if (sdk3Worlds == null)
            {
                throw new InvalidDataException("sdk3Worlds is a required property for DownloadURLList and cannot be null");
            }
            else
            {
