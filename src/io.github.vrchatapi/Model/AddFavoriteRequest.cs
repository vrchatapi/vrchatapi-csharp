...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class AddFavoriteRequest :  IEquatable<AddFavoriteRequest>, IValidatableObject
    {
        ...
        public AddFavoriteRequest(FavoriteType type = default(FavoriteType), string favoriteId = default(string), List<string> tags = default(List<string>))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AddFavoriteRequest and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (favoriteId == null)
            {
                throw new InvalidDataException("favoriteId is a required property for AddFavoriteRequest and cannot be null");
            }
            else
            {
            ...
            if (tags == null)
            {
                throw new InvalidDataException("tags is a required property for AddFavoriteRequest and cannot be null");
            }
            else
            {
                this.Tags = tags;
