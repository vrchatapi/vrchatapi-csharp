...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class PublicAnnouncement :  IEquatable<PublicAnnouncement>, IValidatableObject
    {
        ...
        public PublicAnnouncement(string name = default(string), string text = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PublicAnnouncement and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for PublicAnnouncement and cannot be null");
            }
            else
            {
                this.Text = text;
