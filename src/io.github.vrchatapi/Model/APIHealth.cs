...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class APIHealth :  IEquatable<APIHealth>, IValidatableObject
    {
        ...
        public APIHealth(bool ok = default(bool), string serverName = default(string), string buildVersionTag = default(string))
        {
            ...
            if (ok == null)
            {
                throw new InvalidDataException("ok is a required property for APIHealth and cannot be null");
            }
            else
            {
                this.Ok = ok;
            ...
            if (serverName == null)
            {
                throw new InvalidDataException("serverName is a required property for APIHealth and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("buildVersionTag is a required property for APIHealth and cannot be null");
            }
            else
            {
