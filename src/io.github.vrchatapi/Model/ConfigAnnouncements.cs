...
namespace io.github.vrchatapi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigAnnouncements :  IEquatable<ConfigAnnouncements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigAnnouncements" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ConfigAnnouncements()
        {
        }
        ...
        {
            return this.Equals(input as ConfigAnnouncements);
        }

        /// <summary>
        /// Returns true if ConfigAnnouncements instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigAnnouncements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigAnnouncements input)
        {
            if (input == null)
                return false;
