...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public enum NextPartNumberEnum
        {
            /// <summary>
            /// Enum _0 for value: 0
            /// </summary>
        ...
        public NextPartNumberEnum NextPartNumber { get; set; }
        /// <summary>
        /// Always a zero in string form, despite how many parts uploaded.
        /// </summary>
        /// <value>Always a zero in string form, despite how many parts uploaded.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum MaxPartsEnum
        {
            /// <summary>
            /// Enum _0 for value: 0
            /// </summary>
        ...
        public MaxPartsEnum MaxParts { get; set; }
        /// <summary>
        ...
        /// <param name="nextPartNumber">Always a zero in string form, despite how many parts uploaded. (required) (default to NextPartNumberEnum._0).</param>
        /// <param name="maxParts">Always a zero in string form, despite how many parts uploaded. (required) (default to MaxPartsEnum._0).</param>
        public InlineObject4(List<string> etags = default(List<string>), NextPartNumberEnum nextPartNumber = NextPartNumberEnum._0, MaxPartsEnum maxParts = MaxPartsEnum._0)
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.NextPartNumber != null && this.NextPartNumber.ToString().Length > 1)
            {
            ...
            if(this.MaxParts != null && this.MaxParts.ToString().Length > 1)
            {
