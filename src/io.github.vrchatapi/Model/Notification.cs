...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class Notification :  IEquatable<Notification>, IValidatableObject
    {
        ...
        public Notification(string id = default(string), string senderUserId = default(string), string senderUsername = default(string), NotificationType type = default(NotificationType), string message = default(string), string details = "{}", bool seen = false, DateTime createdAt = default(DateTime))
        {
