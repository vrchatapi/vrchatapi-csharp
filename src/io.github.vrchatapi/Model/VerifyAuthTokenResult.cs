...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class VerifyAuthTokenResult :  IEquatable<VerifyAuthTokenResult>, IValidatableObject
    {
        ...
        public VerifyAuthTokenResult(bool ok = default(bool), string token = default(string))
        {
            ...
            if (ok == null)
            {
                throw new InvalidDataException("ok is a required property for VerifyAuthTokenResult and cannot be null");
            }
            else
            {
                this.Ok = ok;
            ...
            if (token == null)
            {
                throw new InvalidDataException("token is a required property for VerifyAuthTokenResult and cannot be null");
            }
            else
            {
                this.Token = token;
