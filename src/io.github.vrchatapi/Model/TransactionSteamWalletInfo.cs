...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class TransactionSteamWalletInfo :  IEquatable<TransactionSteamWalletInfo>, IValidatableObject
    {
        ...
        public TransactionSteamWalletInfo(string state = default(string), string country = "US", string currency = "USD", string status = default(string))
        {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for TransactionSteamWalletInfo and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            if (country == null)
            {
                throw new InvalidDataException("country is a required property for TransactionSteamWalletInfo and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for TransactionSteamWalletInfo and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for TransactionSteamWalletInfo and cannot be null");
            }
            else
            {
                this.Status = status;
