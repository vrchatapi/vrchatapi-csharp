...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class FinishFileDataUploadRequest :  IEquatable<FinishFileDataUploadRequest>, IValidatableObject
    {
        ...
        public FinishFileDataUploadRequest(List<string> etags = default(List<string>), string nextPartNumber = "0", string maxParts = "0")
        {
            ...
            {
                throw new InvalidDataException("nextPartNumber is a required property for FinishFileDataUploadRequest and cannot be null");
            }
            else
            {
            ...
            if (maxParts == null)
            {
                throw new InvalidDataException("maxParts is a required property for FinishFileDataUploadRequest and cannot be null");
            }
            else
            {
