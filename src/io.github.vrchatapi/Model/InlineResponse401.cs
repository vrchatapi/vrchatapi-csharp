...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class InlineResponse401 :  IEquatable<InlineResponse401>, IValidatableObject
    {
        ...
        public InlineResponse401(Error error = default(Error))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new InvalidDataException("error is a required property for InlineResponse401 and cannot be null");
            }
            else
            {
                this.Error = error;
