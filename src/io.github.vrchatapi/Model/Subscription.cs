...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>, IValidatableObject
    {
        ...
        public Subscription(string id = default(string), string steamItemId = default(string), decimal amount = default(decimal), string description = default(string), SubscriptionPeriod period = default(SubscriptionPeriod), decimal tier = default(decimal))
        {
            ...
            if (steamItemId == null)
            {
                throw new InvalidDataException("steamItemId is a required property for Subscription and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for Subscription and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for Subscription and cannot be null");
            }
            else
            {
            ...
            if (period == null)
            {
                throw new InvalidDataException("period is a required property for Subscription and cannot be null");
            }
            else
            {
                this.Period = period;
            ...
            if (tier == null)
            {
                throw new InvalidDataException("tier is a required property for Subscription and cannot be null");
            }
            else
            {
                this.Tier = tier;
        ...
        /// </summary>
        [DataMember(Name="steamItemId", EmitDefaultValue=true)]
