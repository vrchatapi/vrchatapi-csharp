...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class InlineObject12 :  IEquatable<InlineObject12>, IValidatableObject
    {
        ...
        public InlineObject12(string moderated = default(string), PlayerModerationType type = default(PlayerModerationType))
        {
            // to ensure "moderated" is required (not null)
            if (moderated == null)
            {
                throw new InvalidDataException("moderated is a required property for InlineObject12 and cannot be null");
            }
            else
            {
