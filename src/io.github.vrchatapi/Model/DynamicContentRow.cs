...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class DynamicContentRow :  IEquatable<DynamicContentRow>, IValidatableObject
    {
        ...
        public DynamicContentRow(int index = default(int), string name = default(string), string platform = default(string), string sortHeading = default(string), string sortOrder = default(string), string sortOwnership = default(string), string tag = default(string), string type = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DynamicContentRow and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DynamicContentRow and cannot be null");
            }
            else
            {
            ...
            if (sortHeading == null)
            {
                throw new InvalidDataException("sortHeading is a required property for DynamicContentRow and cannot be null");
            }
            else
            {
            ...
            if (sortOrder == null)
            {
                throw new InvalidDataException("sortOrder is a required property for DynamicContentRow and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sortOwnership is a required property for DynamicContentRow and cannot be null");
            }
            else
            {
