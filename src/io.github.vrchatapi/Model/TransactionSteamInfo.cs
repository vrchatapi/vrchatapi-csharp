...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class TransactionSteamInfo :  IEquatable<TransactionSteamInfo>, IValidatableObject
    {
        ...
        public TransactionSteamInfo(TransactionSteamWalletInfo walletInfo = default(TransactionSteamWalletInfo), string steamId = default(string), string orderId = default(string), string steamUrl = default(string), string transId = default(string))
        {
            ...
            if (walletInfo == null)
            {
                throw new InvalidDataException("walletInfo is a required property for TransactionSteamInfo and cannot be null");
            }
            else
            {
            ...
            if (steamId == null)
            {
                throw new InvalidDataException("steamId is a required property for TransactionSteamInfo and cannot be null");
            }
            else
            {
            ...
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for TransactionSteamInfo and cannot be null");
            }
            else
            {
            ...
            if (steamUrl == null)
            {
                throw new InvalidDataException("steamUrl is a required property for TransactionSteamInfo and cannot be null");
            }
            else
            {
            ...
            if (transId == null)
            {
                throw new InvalidDataException("transId is a required property for TransactionSteamInfo and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="walletInfo", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>Empty</value>
        [DataMember(Name="steamUrl", EmitDefaultValue=true)]
        ...
        [DataMember(Name="transId", EmitDefaultValue=true)]
