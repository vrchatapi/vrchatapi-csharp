...
namespace io.github.vrchatapi.Model
{
    ...
    public partial class InfoPushDataClickable :  IEquatable<InfoPushDataClickable>, IValidatableObject
    {
        ...
        public InfoPushDataClickable(CommandEnum command = default(CommandEnum), List<string> parameters = default(List<string>))
        {
            ...
            if (command == null)
            {
                throw new InvalidDataException("command is a required property for InfoPushDataClickable and cannot be null");
            }
            else
            {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.Command != null && this.Command.ToString().Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Command, length must be greater than 1.", new [] { "Command" });
            }
