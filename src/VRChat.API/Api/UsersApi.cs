...
namespace VRChat.API.Api
{
    ...
    public interface IUsersApiSync : IApiAccessor
    {
        ...
        List<LimitedGroup> GetUserGroups(string userId, int operationIndex = 0);
        ...
        ApiResponse<List<LimitedGroup>> GetUserGroupsWithHttpInfo(string userId, int operationIndex = 0);
        /// <summary>
    ...
    public interface IUsersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<LimitedGroup>> GetUserGroupsAsync(string userId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<LimitedGroup>>> GetUserGroupsWithHttpInfoAsync(string userId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get user&#39;s current represented group
        /// </summary>
        /// <remarks>
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;LimitedGroup&gt;</returns>
        public List<LimitedGroup> GetUserGroups(string userId, int operationIndex = 0)
        {
            VRChat.API.Client.ApiResponse<List<LimitedGroup>> localVarResponse = GetUserGroupsWithHttpInfo(userId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;LimitedGroup&gt;</returns>
        public VRChat.API.Client.ApiResponse<List<LimitedGroup>> GetUserGroupsWithHttpInfo(string userId, int operationIndex = 0)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<LimitedGroup>>("/users/{userId}/groups", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;LimitedGroup&gt;</returns>
        public async System.Threading.Tasks.Task<List<LimitedGroup>> GetUserGroupsAsync(string userId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            VRChat.API.Client.ApiResponse<List<LimitedGroup>> localVarResponse = await GetUserGroupsWithHttpInfoAsync(userId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;LimitedGroup&gt;)</returns>
        public async System.Threading.Tasks.Task<VRChat.API.Client.ApiResponse<List<LimitedGroup>>> GetUserGroupsWithHttpInfoAsync(string userId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<LimitedGroup>>("/users/{userId}/groups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
