...
namespace VRChat.API.Api
{
    ...
    public interface IInstancesApiSync : IApiAccessor
    {
        ...
        Instance CloseInstance(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0);
        ...
        ApiResponse<Instance> CloseInstanceWithHttpInfo(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0);
        /// <summary>
        /// Get Instance
        /// </summary>
        /// <remarks>
    ...
    public interface IInstancesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Instance> CloseInstanceAsync(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Instance>> CloseInstanceWithHttpInfoAsync(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Instance
        /// </summary>
        /// <remarks>
    ...
    public partial class InstancesApi : IInstancesApi
    {
        ...
        /// <summary>
        /// Close Instance Close an instance.  You can only close an instance if the ownerId is yourself or if the instance owner is a group and you have the &#x60;group-instance-moderate&#x60; permission.
        /// </summary>
        /// <exception cref="VRChat.API.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="worldId">Must be a valid world ID.</param>
        /// <param name="instanceId">Must be a valid instance ID.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Instance</returns>
        public Instance CloseInstance(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0)
        {
            VRChat.API.Client.ApiResponse<Instance> localVarResponse = CloseInstanceWithHttpInfo(worldId, instanceId, hardClose);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Instance</returns>
        public VRChat.API.Client.ApiResponse<Instance> CloseInstanceWithHttpInfo(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Instance</returns>
        public async System.Threading.Tasks.Task<Instance> CloseInstanceAsync(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            VRChat.API.Client.ApiResponse<Instance> localVarResponse = await CloseInstanceWithHttpInfoAsync(worldId, instanceId, hardClose, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Instance)</returns>
        public async System.Threading.Tasks.Task<VRChat.API.Client.ApiResponse<Instance>> CloseInstanceWithHttpInfoAsync(string worldId, string instanceId, bool? hardClose = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
            {
