...
namespace VRChat.API.Api
{
    ...
    public partial class FilesApi : IFilesApi
    {
        ...
        /// <param name="partNumber"></param>
        /// <returns>ApiResponse of FileUploadURL</returns>
        public VRChat.API.Client.ApiResponse<FileUploadURL> StartFileDataUploadWithHttpInfo(string fileId, int versionId, string fileType, int partNumber)
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileUploadURL)</returns>
        public async System.Threading.Tasks.Task<VRChat.API.Client.ApiResponse<FileUploadURL>> StartFileDataUploadWithHttpInfoAsync(string fileId, int versionId, string fileType, int partNumber, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'fileId' is set
            if (fileId == null)
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'fileId' when calling FilesApi->StartFileDataUpload");
