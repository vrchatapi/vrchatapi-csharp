    ...
    public partial class AvatarsApi : IDisposable, IAvatarsApi
    {
        ...
        public VRChat.API.Client.ApiResponse<Avatar> CreateAvatarWithHttpInfo(CreateAvatarRequest? createAvatarRequest = default)
        {
            ...
            catch (VRChat.API.Client.ApiException ex)
            {
                ...
                return new VRChat.API.Client.ApiResponse<Avatar>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(Avatar), ex.Message);
            }
        }
        ...
        {
            VRChat.API.Client.ApiResponse<Object> localVarResponse = DeleteImpostorWithHttpInfo(avatarId);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            VRChat.API.Client.ApiResponse<Object> localVarResponse = await DeleteImpostorWithHttpInfoAsync(avatarId, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteImpostor", localVarResponse);
                if (_exception != null)
        ...
        public VRChat.API.Client.ApiResponse<ServiceStatus> EnqueueImpostorWithHttpInfo(string avatarId)
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<ServiceStatus>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(ServiceStatus), ex.Message);
            }
        }
        ...
        public VRChat.API.Client.ApiResponse<List<AvatarStyle>> GetAvatarStylesWithHttpInfo()
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<List<AvatarStyle>>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(List<AvatarStyle>), ex.Message);
            }
        }
        ...
        public VRChat.API.Client.ApiResponse<List<Avatar>> GetFavoritedAvatarsWithHttpInfo(bool? featured = default, SortOption? sort = default, int? n = default, OrderOption? order = default, int? offset = default, string? search = default, string? tag = default, string? notag = default, ReleaseStatus? releaseStatus = default, string? maxUnityVersion = default, string? minUnityVersion = default, string? platform = default, string? userId = default)
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<List<Avatar>>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(List<Avatar>), ex.Message);
            }
        }
        ...
        public VRChat.API.Client.ApiResponse<ServiceQueueStats> GetImpostorQueueStatsWithHttpInfo()
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<ServiceQueueStats>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(ServiceQueueStats), ex.Message);
            }
        }
