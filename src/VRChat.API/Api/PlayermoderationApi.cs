...
namespace VRChat.API.Api
{
    ...
    public partial class PlayermoderationApi : IDisposable, IPlayermoderationApi
    {
        ...
        public VRChat.API.Client.ApiResponse<List<PlayerModeration>> GetPlayerModerationsWithHttpInfo(PlayerModerationType? type = default, string? targetUserId = default)
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<List<PlayerModeration>>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(List<PlayerModeration>), ex.Message);
            }
        }
        ...
        public VRChat.API.Client.ApiResponse<PlayerModeration> ModerateUserWithHttpInfo(ModerateUserRequest moderateUserRequest)
        {
            ...
            {
                // Return response with error information instead of throwing
                return new VRChat.API.Client.ApiResponse<PlayerModeration>((System.Net.HttpStatusCode)ex.ErrorCode, new VRChat.API.Client.Multimap<string, string>(), default(PlayerModeration), ex.Message);
            }
        }
