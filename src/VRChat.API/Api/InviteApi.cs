...
namespace VRChat.API.Api
{
    ...
    public interface IInviteApiSync : IApiAccessor
    {
        ...
        /// <param name="inviteMyselfToRequest"> (optional)</param>
        /// <returns>SentNotification</returns>
        SentNotification InviteMyselfTo(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest));
        ...
        ApiResponse<SentNotification> InviteMyselfToWithHttpInfo(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest));
        /// <summary>
        /// Invite User
        /// </summary>
        /// <remarks>
    ...
    public interface IInviteApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SentNotification> InviteMyselfToAsync(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SentNotification>> InviteMyselfToWithHttpInfoAsync(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Invite User
        /// </summary>
        /// <remarks>
    ...
    public partial class InviteApi : IInviteApi
    {
        ...
        /// <param name="inviteMyselfToRequest"> (optional)</param>
        /// <returns>SentNotification</returns>
        public SentNotification InviteMyselfTo(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest))
        {
            VRChat.API.Client.ApiResponse<SentNotification> localVarResponse = InviteMyselfToWithHttpInfo(worldId, instanceId, inviteMyselfToRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inviteMyselfToRequest"> (optional)</param>
        /// <returns>ApiResponse of SentNotification</returns>
        public VRChat.API.Client.ApiResponse<SentNotification> InviteMyselfToWithHttpInfo(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest))
        {
            ...
            localVarRequestOptions.Data = inviteMyselfToRequest;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SentNotification</returns>
        public async System.Threading.Tasks.Task<SentNotification> InviteMyselfToAsync(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            VRChat.API.Client.ApiResponse<SentNotification> localVarResponse = await InviteMyselfToWithHttpInfoAsync(worldId, instanceId, inviteMyselfToRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SentNotification)</returns>
        public async System.Threading.Tasks.Task<VRChat.API.Client.ApiResponse<SentNotification>> InviteMyselfToWithHttpInfoAsync(string worldId, string instanceId, InviteMyselfToRequest inviteMyselfToRequest = default(InviteMyselfToRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'worldId' is set
            if (worldId == null)
                throw new VRChat.API.Client.ApiException(400, "Missing required parameter 'worldId' when calling InviteApi->InviteMyselfTo");
