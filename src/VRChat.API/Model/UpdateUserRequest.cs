...
namespace VRChat.API.Model
{
    ...
    public partial class UpdateUserRequest : IEquatable<UpdateUserRequest>, IValidatableObject
    {
        ...
        public UpdateUserRequest(string email = default(string), DateTime birthday = default(DateTime), decimal acceptedTOSVersion = default(decimal), List<string> tags = default(List<string>), UserStatus? status = default(UserStatus?), string statusDescription = default(string), string bio = default(string), List<string> bioLinks = default(List<string>), string pronouns = default(string), bool isBoopingEnabled = default(bool), string userIcon = default(string))
        {
            this.Email = email;
