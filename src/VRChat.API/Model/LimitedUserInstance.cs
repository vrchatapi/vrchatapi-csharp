...
namespace VRChat.API.Model
{
    ...
    public partial class LimitedUserInstance : IEquatable<LimitedUserInstance>, IValidatableObject
    {
        ...
        public LimitedUserInstance(AgeVerificationStatus ageVerificationStatus = default(AgeVerificationStatus), bool ageVerified = default(bool), bool allowAvatarCopying = default(bool), string bio = default(string), List<string> bioLinks = default(List<string>), string currentAvatarImageUrl = default(string), string currentAvatarThumbnailImageUrl = default(string), List<string> currentAvatarTags = default(List<string>), DateTime? dateJoined = default(DateTime?), DeveloperType developerType = default(DeveloperType), string displayName = default(string), string friendKey = default(string), string id = default(string), bool isFriend = default(bool), string imageUrl = default(string), string lastPlatform = default(string), DateTime? lastActivity = default(DateTime?), DateTime? lastMobile = default(DateTime?), string platform = default(string), string profilePicOverride = default(string), string profilePicOverrideThumbnail = default(string), string pronouns = default(string), UserState state = default(UserState), UserStatus status = default(UserStatus), string statusDescription = default(string), List<string> tags = default(List<string>), string userIcon = default(string))
        {
            ...
            if (lastMobile == null)
            {
                throw new ArgumentNullException("lastMobile is a required property for LimitedUserInstance and cannot be null");
            }
            this.LastMobile = lastMobile;
            // to ensure "profilePicOverride" is required (not null)
            if (profilePicOverride == null)
            {
                throw new ArgumentNullException("profilePicOverride is a required property for LimitedUserInstance and cannot be null");
            }
            this.ProfilePicOverride = profilePicOverride;
            // to ensure "profilePicOverrideThumbnail" is required (not null)
            if (profilePicOverrideThumbnail == null)
            {
                throw new ArgumentNullException("profilePicOverrideThumbnail is a required property for LimitedUserInstance and cannot be null");
            }
            ...
            if (userIcon == null)
            {
                throw new ArgumentNullException("userIcon is a required property for LimitedUserInstance and cannot be null");
            }
