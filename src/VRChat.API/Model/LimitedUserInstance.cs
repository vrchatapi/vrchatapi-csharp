...
namespace VRChat.API.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LimitedUserInstance")]
    public partial class LimitedUserInstance : IEquatable<LimitedUserInstance>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitedUserInstance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LimitedUserInstance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LimitedUserInstance" /> class.
        /// </summary>
        ...
        public LimitedUserInstance(AgeVerificationStatus ageVerificationStatus = default, bool ageVerified = default, bool allowAvatarCopying = default, string bio = default, List<string> bioLinks = default, string currentAvatarImageUrl = default, List<string> currentAvatarTags = default, string currentAvatarThumbnailImageUrl = default, DateTime? dateJoined = default, DeveloperType developerType = default, string displayName = default, string friendKey = default, string id = default, string imageUrl = default, bool isFriend = default, DateTime? lastActivity = default, DateTime? lastMobile = default, string lastPlatform = default, string platform = default, string profilePicOverride = default, string profilePicOverrideThumbnail = default, string pronouns = default, UserState? state = default, UserStatus status = default, string statusDescription = default, List<string> tags = default, string userIcon = default)
        {
        ...
        */
        ...
        {
            return this.Equals(input as LimitedUserInstance);
        }

        /// <summary>
        /// Returns true if LimitedUserInstance instances are equal
        /// </summary>
        /// <param name="input">Instance of LimitedUserInstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LimitedUserInstance input)
        {
            if (input == null)
            {
                return false;
