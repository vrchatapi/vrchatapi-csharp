...
namespace VRChat.API.Model
{
    ...
    public partial class Permission : IEquatable<Permission>, IValidatableObject
    {
        ...
        public Permission(string id = default(string), string ownerDisplayName = default(string), string name = default(string), string ownerId = default(string), Object data = default(Object))
        {
