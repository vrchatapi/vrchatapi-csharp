...
namespace VRChat.API.Model
{
    ...
    public partial class Permission : IEquatable<Permission>, IValidatableObject
    {
        ...
        public Permission(Object data = default, string description = default, string displayName = default, string id = default, string name = default, string ownerDisplayName = default, string ownerId = default, string type = default)
        {
