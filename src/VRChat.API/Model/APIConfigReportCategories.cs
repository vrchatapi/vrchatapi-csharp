...
namespace VRChat.API.Model
{
    ...
    public partial class APIConfigReportCategories : IEquatable<APIConfigReportCategories>, IValidatableObject
    {
        ...
        public APIConfigReportCategories(ReportCategory avatar = default, ReportCategory avatarpage = default, ReportCategory behavior = default, ReportCategory chat = default, ReportCategory emoji = default, ReportCategory varEnvironment = default, ReportCategory groupstore = default, ReportCategory image = default, ReportCategory sticker = default, ReportCategory text = default, ReportCategory warnings = default, ReportCategory worldimage = default, ReportCategory worldstore = default)
        {
