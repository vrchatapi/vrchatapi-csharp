...
namespace VRChat.API.Model
{
    ...
    public partial class File : IEquatable<File>, IValidatableObject
    {
        ...
        public File(string animationStyle = default, string extension = default, string id = default, string maskTag = default, MIMEType mimeType = default, string name = default, string ownerId = default, List<string> tags = default, List<FileVersion> versions = default)
        {
