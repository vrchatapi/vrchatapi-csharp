...
namespace VRChat.API.Model
{
    ...
    public partial class TokenBundle : IEquatable<TokenBundle>, IValidatableObject
    {
        ...
        public TokenBundle(string id = default(string), string steamItemId = default(string), string oculusSku = default(string), string googleProductId = default(string), int amount = default(int), string description = default(string), int tokens = default(int), string imageUrl = default(string))
        {
