...
namespace VRChat.API.Model
{
    ...
    public partial class CreateInstanceRequest : IEquatable<CreateInstanceRequest>, IValidatableObject
    {
        ...
        public CreateInstanceRequest(bool ageGate = false, bool canRequestInvite = false, DateTime closedAt = default, InstanceContentSettings contentSettings = default, string displayName = default, GroupAccessType? groupAccessType = default, bool hardClose = false, bool? instancePersistenceEnabled = default, bool inviteOnly = false, string ownerId = default, bool queueEnabled = false, InstanceRegion region = default, List<string> roleIds = default, InstanceType type = default, string worldId = default)
        {
            this.Region = region;
            this.Type = type;
