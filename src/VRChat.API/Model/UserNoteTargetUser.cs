...
namespace VRChat.API.Model
{
    ...
    public partial class UserNoteTargetUser : IEquatable<UserNoteTargetUser>, IValidatableObject
    {
        ...
        public UserNoteTargetUser(string id = default, List<string> currentAvatarTags = default, string currentAvatarThumbnailImageUrl = default, string displayName = default, string profilePicOverride = default, string userIcon = default)
        {
            this.Id = id;
