...
namespace VRChat.API.Model
{
    ...
    public partial class RepresentedGroup : IEquatable<RepresentedGroup>, IValidatableObject
    {
        ...
        public RepresentedGroup(string bannerId = default, string bannerUrl = default, string description = default, string discriminator = default, string groupId = default, string iconId = default, string iconUrl = default, bool isRepresenting = default, int memberCount = default, GroupUserVisibility? memberVisibility = default, string name = default, Object nameplateId = default, Object nameplateUrl = default, string ownerId = default, GroupPrivacy? privacy = default, string shortCode = default)
        {
