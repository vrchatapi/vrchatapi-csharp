...
namespace VRChat.API.Model
{
    ...
    public partial class Instance : IEquatable<Instance>, IValidatableObject
    {
        ...
        /// <param name="roleRestricted">roleRestricted (required).</param>
        ...
        public Instance(bool active = true, bool canRequestInvite = true, int capacity = default(int), string clientNumber = default(string), bool full = false, string id = default(string), string instanceId = default(string), string location = default(string), int nUsers = default(int), string name = default(string), string ownerId = default(string), bool permanent = false, Region photonRegion = default(Region), InstancePlatforms platforms = default(InstancePlatforms), Region region = default(Region), string secureName = default(string), string shortName = default(string), List<string> tags = default(List<string>), InstanceType type = default(InstanceType), string worldId = default(string), string hidden = default(string), string friends = default(string), string _private = default(string), bool queueEnabled = default(bool), int queueSize = default(int), int recommendedCapacity = default(int), bool roleRestricted = default(bool), bool strict = default(bool), int userCount = default(int), World world = default(World), List<LimitedUser> users = default(List<LimitedUser>))
        {
            this.Active = active;
        ...
        /// </summary>
        [DataMember(Name = "roleRestricted", IsRequired = true, EmitDefaultValue = true)]
