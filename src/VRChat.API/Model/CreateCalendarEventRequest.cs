...
namespace VRChat.API.Model
{
    ...
    public partial class CreateCalendarEventRequest : IEquatable<CreateCalendarEventRequest>, IValidatableObject
    {
        ...
        public CreateCalendarEventRequest(AccessTypeEnum accessType = default, string category = default, int closeInstanceAfterEndMinutes = default, string description = default, DateTime endsAt = default, bool featured = default, int guestEarlyJoinMinutes = default, int hostEarlyJoinMinutes = default, string imageId = default, bool isDraft = default, List<string> languages = default, string parentId = default, List<string> platforms = default, List<string> roleIds = default, bool sendCreationNotification = default, DateTime startsAt = default, List<string> tags = default, string title = default, bool usesInstanceOverflow = default)
        {
