...
namespace VRChat.API.Model
{
    ...
    public partial class FileData : IEquatable<FileData>, IValidatableObject
    {
        ...
        public FileData(string fileName = default(string), string md5 = default(string), int sizeInBytes = default(int), FileStatus status = default(FileStatus), string uploadId = "", string url = default(string))
        {
