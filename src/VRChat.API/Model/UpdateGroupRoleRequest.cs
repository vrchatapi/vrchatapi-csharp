...
namespace VRChat.API.Model
{
    ...
    public partial class UpdateGroupRoleRequest : IEquatable<UpdateGroupRoleRequest>, IValidatableObject
    {
        ...
        public UpdateGroupRoleRequest(string name = default(string), string description = default(string), bool isSelfAssignable = false, List<PermissionsEnum> permissions = default(List<PermissionsEnum>), int order = default(int))
        {
            this.Name = name;
        ...
        public List<UpdateGroupRoleRequest.PermissionsEnum> Permissions { get; set; }
