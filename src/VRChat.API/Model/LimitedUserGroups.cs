...
namespace VRChat.API.Model
{
    ...
    public partial class LimitedUserGroups : IEquatable<LimitedUserGroups>, IValidatableObject
    {
        ...
        public LimitedUserGroups(string bannerId = default, string bannerUrl = default, string description = default, string discriminator = default, string groupId = default, string iconId = default, string iconUrl = default, string id = default, bool isRepresenting = default, DateTime? lastPostCreatedAt = default, DateTime? lastPostReadAt = default, int memberCount = default, string memberVisibility = default, bool mutualGroup = default, string name = default, string ownerId = default, string privacy = default, string shortCode = default)
        {
