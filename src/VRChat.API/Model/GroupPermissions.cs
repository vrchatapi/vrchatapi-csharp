...
namespace VRChat.API.Model
{
    ...
    public enum GroupPermissions
    {
        ...
        /// <summary>
        /// Enum group_calendar_manage for value: group-calendar-manage
        /// </summary>
        [EnumMember(Value = "group-calendar-manage")]
        group_calendar_manage = 5,
