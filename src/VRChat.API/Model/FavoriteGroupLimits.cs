...
namespace VRChat.API.Model
{
    ...
    public partial class FavoriteGroupLimits : IEquatable<FavoriteGroupLimits>, IValidatableObject
    {
        ...
        /// <param name="vrcPlusWorld">vrcPlusWorld (required).</param>
        /// <param name="world">world (required).</param>
        public FavoriteGroupLimits(int avatar = default, int friend = default, int vrcPlusWorld = default, int world = default)
        {
            this.Avatar = avatar;
            this.Friend = friend;
        ...
        /// <summary>
        /// Gets or Sets VrcPlusWorld
        /// </summary>
        [DataMember(Name = "vrcPlusWorld", IsRequired = true, EmitDefaultValue = true)]
        public int VrcPlusWorld { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VrcPlusWorld: ").Append(VrcPlusWorld).Append("\n");
        ...
        public bool Equals(FavoriteGroupLimits input)
        {
            ...
            return 
                ...
                (
                    this.VrcPlusWorld == input.VrcPlusWorld ||
                    this.VrcPlusWorld.Equals(input.VrcPlusWorld)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VrcPlusWorld.GetHashCode();
