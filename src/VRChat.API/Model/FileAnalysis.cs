...
namespace VRChat.API.Model
{
    ...
    public partial class FileAnalysis : IEquatable<FileAnalysis>, IValidatableObject
    {
        ...
        public FileAnalysis(FileAnalysisAvatarStats avatarStats = default(FileAnalysisAvatarStats), DateTime createdAt = default(DateTime), int fileSize = default(int), bool success = default(bool), int uncompressedSize = default(int))
        {
