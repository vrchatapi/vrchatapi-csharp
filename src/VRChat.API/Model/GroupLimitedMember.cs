...
namespace VRChat.API.Model
{
    ...
    public partial class GroupLimitedMember : IEquatable<GroupLimitedMember>, IValidatableObject
    {
        ...
        public GroupLimitedMember(DateTime? bannedAt = default, DateTime? createdAt = default, string groupId = default, bool hasJoinedFromPurchase = default, string id = default, bool isRepresenting = false, bool isSubscribedToAnnouncements = false, bool isSubscribedToEventAnnouncements = default, DateTime? joinedAt = default, DateTime? lastPostReadAt = default, List<string> mRoleIds = default, string managerNotes = default, GroupMemberStatus? membershipStatus = default, List<string> roleIds = default, string userId = default, string visibility = default)
        {
