...
namespace io.github.vrchatapi.Test
{
    ...
    public class PermissionsApiTests
    {
        ...
        /// <summary>
        /// Test GetAssignedPermissions
        /// </summary>
        [Test]
        public void GetAssignedPermissionsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetAssignedPermissions();
            //Assert.IsInstanceOf(typeof(List<Permission>), response, "response is List<Permission>");
        }
        ...
        public void GetPermissionTest()
        {
            ...
            //var response = instance.GetPermission(permissionId);
            //Assert.IsInstanceOf(typeof(Permission), response, "response is Permission");
        }
