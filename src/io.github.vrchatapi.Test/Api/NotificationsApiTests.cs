...
namespace io.github.vrchatapi.Test
{
    ...
    public class NotificationsApiTests
    {
        ...
        public void AcceptFriendRequestTest()
        {
            ...
            //var response = instance.AcceptFriendRequest(notificationId);
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ClearNotifications();
            //Assert.IsInstanceOf(typeof(Success), response, "response is Success");
        }
        ...
        public void GetNotificationsTest()
        {
            ...
            //int? n = null;
            //int? offset = null;
            //var response = instance.GetNotifications(type, sent, hidden, after, n, offset);
            //Assert.IsInstanceOf(typeof(List<Notification>), response, "response is List<Notification>");
        }
        ...
        public void MarkNotificationAsReadTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string notificationId = null;
            //var response = instance.MarkNotificationAsRead(notificationId);
            //Assert.IsInstanceOf(typeof(Notification), response, "response is Notification");
        }
