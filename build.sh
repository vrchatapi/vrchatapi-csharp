...
${nuget_cmd} install src/io.github.vrchatapi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/io.github.vrchatapi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/io.github.vrchatapi.dll \
-recurse:'src/io.github.vrchatapi/*.cs' \
-doc:bin/io.github.vrchatapi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/io.github.vrchatapi.dll was created successfully"
fi
